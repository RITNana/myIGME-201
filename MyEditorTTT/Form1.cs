...
namespace MyEditor
{
    public partial class Form1 : Form
    {
        public Form1(MyEditorParent myEditorParent)
        {
          ...
          //  this.newToolStripMenuItem.Click += new EventHandler(NewToolStripMenuItem__Click);
           ...
           // this.exitToolStripMenuItem.Click += new EventHandler(ExitToolStripMenuItem__Click);
            ...
            myEditorParent.closeAllToolStripMenuItem.Click += new EventHandler(CloseAllToolStripMenuItem);
        ...
        private void MSSansSerifToolStripMenuItem__Click(object obj, EventArgs e)
        {
        ...
        private void RichTextBox__SelectionChanged(object obj, EventArgs e)
        {
