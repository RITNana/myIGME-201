    ...
    public partial class LinkedList : Form
    {
       ...
       */
        ...
        private void Button4__Click(object sender, EventArgs e)
        {
            ...
            LinkedList<object> linkedList = null;
            LinkedListNode<object> linkedListNode;
            string[] sentence = {"Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like", "a", "room", "without", "a", "roof",
            "Because", "I'm", "sad", "Clap", "along", "if", "you", "feel", "like", "sadness", "is", "the", "truth", "sad"};
            ...
            {
                linkedListNode = linkedList.Find(word);
        ...
        private void Button5__Click(object sender, EventArgs e)
        {
            ...
            linkedList.Remove("Spain");
           

            try
            {
                linkedList.AddBefore(linkedList.Find("in"),linkedListNode1);
                linkedList.AddAfter(linkedList.Find("in"), linkedListNode2);

                linkedList.Find("plain");
                linkedList.Find("mainly");
                linkedList.Find("in");
                linkedList.Find("on");
                linkedList.Find("the");

                linkedList.Remove( "plain");
                linkedList.Remove("mainly");

                LinkedListNode<object> plainNode = new LinkedListNode<object>("plain");
                LinkedListNode<object> mainlyNode = new LinkedListNode<object>("mainly");

                linkedList.AddAfter(linkedList.Find("falls"), mainlyNode);
                linkedList.AddAfter(linkedList.Find("the"), plainNode);
        ...
        private void Button6__Click(object sender, EventArgs e)
        {
            ...
            try
            {
                anagram.AddAfter(anagram.Find("I"), linkedListNode2);

                anagram.Remove("Y");
                LinkedListNode<object> yNode = new LinkedListNode<object>("Y");
                anagram.AddAfter(anagram.Find("T"), yNode);

                anagram.Remove("M");
                LinkedListNode<object> mNode = new LinkedListNode<object>("M");
                anagram.AddLast("M");

                anagram.Remove("R");
                LinkedListNode<object> rNode = new LinkedListNode<object>("R");
                anagram.AddBefore(anagram.Find("O"), rNode);
